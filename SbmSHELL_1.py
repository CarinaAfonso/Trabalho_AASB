# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 20:15:01 2020
...
class SbmSHELL_1(Cmd):
    prompt = 'SeqBioManager> '
    intro = '''                             
                    MENU Adicionar Sequências                                  
  ===========================================================
    
         1. Adicionar manualmente
         2. Adicionar a partir de um ficheiro
         3. Adicionar a partir da base de dados do NCBI
  ...
  ===========================================================
        ...
        try:
            ...
            if state:
                ...
                if input_seq == 'fasta' or input_seq == 'faa':
                    ...
                    print('load_squence')     
                    (state_file, n_seq_val, n_seq_nval) = eng.load_sequence_txt(file_name)
                    if state_file:
    ...
    def do_3(self, arg):
        'Comando para adicionar uma sequência ao gestor a partir da base de dados do NCBI: 3'
        try:
            id_prot = input('Introduza o ID da proteína na base de Dados do NCBI:')
            eng.get_sequence_ncbi(id_prot)
            print('\nSequencia adicionada com sucesso.\nNúmero da sequência: ', eng.last_id)
            print(menu)
        except:
            print('Erro: ID não encontrado. Verifique se o ID que introduziu é válido')
            print(menu)
